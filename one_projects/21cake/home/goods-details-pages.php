...
//价格
	...
	$sql = 'select i.icon, g.name, g.sales, g.look, g.id, g.stock
			from  goods g, goodsImg i
			where  g.id = i.gid and up = 1 and face = 1 and g.id = '.$id;
	$goods_list = query($sql)[0];

	$sql = 'select c.comment, u.nickname
			from goodscomment c, user u
 	...
 	<div id="main">
 				...
 				<div class="information">
 					...
 					<div class="product-buy">
 						...
 						<ul class="guige">
 							<li>
 								<div class="box">
 									<div class="com"><img src="<?= IMG?>size.png" alt=""></div>
 									<div class="com">13x13cm</div>
 								</div>
 								<div class="box">
 									<div class="com"><img src="<?= IMG?>persons.png" alt=""></div>
 									<div class="com">适合3-4人分享</div>
 								</div>
 								<div class="box">
 									<div class="com"><img src="<?= IMG?>plates.png" alt=""></div>
 									<div class="com">含5套餐具</div>
 								</div>
 								<div class="box">
	 							...
	 							<ul>
	 								<li class="Num">
	 									<span class="num">
	 										...
	 										<span class="time" href="">浏览<?=$goods_list['look']?>次</span>
	 										<span class="time" href="" style="padding-right:30px;">已售<?=$goods_list['sales']?>件</span>
 		...
 		<div class="bottom">
 			...
 			<div class="tags-hd-active">
 				...
 				<div>
 				<span  style="font-size:14px;">商品详情</span></div>
 			</div>
 		...
 		<div class="bottom">
 			...
 			<div class="tags-hd-active">
 				...
 				<span  style="font-size:14px;" >商品评论</span></div>
 			</div>
	 	</div>
 		<?php foreach($comment as $k =>$v):?>
	 		<div>
	 			<table style="padding-left:40px;background:#f8f8f8;width:1200px;">
	 				<tr>
	 					<th style="text-align:left;">用户&nbsp;:&nbsp;<?= empty($_SESSION['home']['nickname'])? $_SESSION['home']['tel']:$_SESSION['home']['nickname']?></th>
	 				</tr>
	 				<tr style="border-bottom:1px solid #f1f1f1;display:block;">
	 					<td>评论&nbsp;:&nbsp;<?=$v['comment']?></td>
	 				</tr>
	 			</table>
	 		</div>
