...
<div class="content">
	<div class="top">
    	<div class="link"><a class="i" href="#_">设为首页</a>&nbsp;&nbsp;<a class="a" href="#_">加入收藏</a>&nbsp;&nbsp;<a href="#_" class="sbutton">余额查询</a></div>
    	<div class="logo"><a href="#_"></a></div>
    </div>
    <div class="nav">
    	<div class="search">
        	<input type="text" class="text" /><input type="button" value="" class="button" />
        </div>
    	<ul class="list">
        	<li class="select">
    ...
    <div class="ctel">
   	<img src="images/mark.jpg" width="22" height="21" />&nbsp;<span class="tt">养生热线：</span>0576-81234559 189065589661 </div>
    <div class="banner">
    	<div class="clear" id="slider-bg">
            <div class="full-width-wrapper" id="slider-frame">
                <div class="fixed-width-wrapper maxx-theme" id="slider-wrapper">
                    ...
                    <a href="javascript:void(0)"><img src="../public/images/banner.jpg" alt="懒人图库"></a>
                    <a href="javascript:void(0)"><img src="../public/images/banner01.jpg" alt="懒人图库"></a>
                    <a href="javascript:void(0)"><img src="../public/images/banner.jpg" alt="懒人图库"></a>
                    </div>
                </div>
            </div>
    ...
    <div class="main">
    	<div class="mleft">
            ...
            <div class="ad"><a href="#_"><img src="../public/images/ad04.jpg" width="240" height="286" /></a></div>
        </div>
        <div class="mright">
        	<div class="ad">
            	<div class="vcontainer" id="idTransformView">
                    <ul class="vslider" id="idSlider">
                        <li><img src="../public/images/ad05.jpg" width="722" height="286" /></li>
                        <li><img src="../public/images/ad05.jpg" width="722" height="286" /></li>
                        <li><img src="../public/images/ad05.jpg" width="722" height="286" /></li>
                        <li><img src="../public/images/ad05.jpg" width="722" height="286" /></li>
                    </ul>
        	...
        	<div class="commend">
            	<div class="picgd"> <a href="#" onclick="return false" title="上翻" id="LeftArr" class="up png">上翻</a> <a href="#" onclick="return false" title="下翻" id="RightArr" class="down png">下翻</a>
                  <div id="pic" class="pic">
                    <ul id="scrollPic">
                      <li>
                        <p class="media"><a href="#_"><img src="../public/images/p.jpg" width="203" height="131" /></a></p>
    ...
    <div class="main main01">
    	<div class="mleft">
            ...
            <div class="ad"><a href="#_"><img src="../public/images/ad02.jpg" width="240" height="347" /></a></div>
        </div>
        <div class="mright">
        	<div class="ad">
            	<div class="vcontainer" id="idTransformView01">
                    <ul class="vslider" id="idSlider01">
                        <li><img src="../public/images/ad03.jpg" width="722" height="286" /></li>
                        <li><img src="../public/images/ad03.jpg" width="722" height="286" /></li>
                        <li><img src="../public/images/ad03.jpg" width="722" height="286" /></li>
                        <li><img src="../public/images/ad03.jpg" width="722" height="286" /></li>
                    </ul>
    ...
    <div class="main main01">
    	<div class="mleft">
            ...
            <div class="ad"><a href="#_"><img src="../public/images/ad.jpg" width="240" height="347" /></a></div>
        </div>
        <div class="mright">
        	<div class="ad">
            	<div class="vcontainer" id="idTransformView02">
                    <ul class="vslider" id="idSlider02">
                        <li><img src="../public/images/ad01.jpg" width="722" height="286" /></li>
                        <li><img src="../public/images/ad01.jpg" width="722" height="286" /></li>
                        <li><img src="../public/images/ad01.jpg" width="722" height="286" /></li>
                        <li><img src="../public/images/ad01.jpg" width="722" height="286" /></li>
                    </ul>
...
身份的品牌、
        ...
        <div class="news">
            ...
            <div class="bd">
            	<div class="first">
                	<div class="media"><a href="#_"><img src="../public/images/news.jpg" width="108" height="66" /></a></div>
                	<div class="intro">
    ...
    <div class="footer">浙ICP备案12345678  版权所有 台州天慈天养土特产  技术支持：<a href="#_">千寻科技</a></div>
</div>
</body>
</html>
