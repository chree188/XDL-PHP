...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：<a href="index.php">类别模块</a>&nbsp;&nbsp;>&nbsp;&nbsp;添加类别</td>
  </tr>
  <tr>
    <td align="left" valign="top" id="addinfo">
    <a href="add.php" target="mainFrame" onFocus="this.blur()" class="add">新增类别</a>
    </td>
  </tr>
  <tr>
    ...
    <?php
		...
		switch(@$_GET['errno']) {
			case 1 :
				echo "<h2 style='color:red; '>添加失败，该类别已存在</h2>";
				break;
			case 2 :
