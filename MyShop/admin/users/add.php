...
<html lang="en">
	...
	<body>
		<form action="../users/action.php?a=insert" method="post">
			账&nbsp;&nbsp;号:
			<input type="text" name="username" class="text05">
			<br>
			<br>
			真实姓名:
			...
			<br>
			密&nbsp;&nbsp;码:
			<input type="text" name="pass" class="text05">
			<br>
			<br>
			<label>性&nbsp;&nbsp;别:
			...
			<br>
			Email :&nbsp;
			<input type="text" name="email" class="text05">
			<br>
			<br>
			注册时间:
			<input type="text" name="addtime" class="text05">
			<br>
			<br>
