...
values('admin','zwt','zwt12345',1,'浙江省开化县','324300','13777399387','zwt0706@126.com',20160715);
...
values(1,'芝麻油','绍兴清香食品厂','这是芝麻油',99.90,'../../public/images/uploads/oil.jpg',100,15,20160715);
insert into goods (typeid,goods,company,descr,price,picname,store,num,addtime) 
values(1,'玉米油','嘉兴清香食品厂','这是玉米油',55.80,'../../public/images/uploads/oil.jpg',50,6,20160715);
insert into goods (typeid,goods,company,descr,price,picname,state,store,num,addtime) 
values(1,'花生油','山东廉价食品厂','~~~这是花生油',49.50,'../../public/images/uploads/oil.jpg',2,80,3,20160715);
insert into goods (typeid,goods,company,descr,price,picname,state,store,addtime) 
values(1,'橄榄油','上海旅游食品厂','这是橄榄油！！！',199.90,'../../public/images/uploads/oil.jpg',3,30,20160715);
