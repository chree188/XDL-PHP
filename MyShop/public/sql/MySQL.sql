...
insert  into `detail`(`id`,`orderid`,`goodsid`,`name`,`price`,`num`,`status`) values (2,1,10,'金龙鱼',59.90,1,'2'),(3,2,15,'香蕉',8.90,5,'2'),(4,2,16,'珍品海参',119.89,3,'2'),(5,2,14,'大草鱼',26.00,1,'2'),(6,2,1,'江南菜籽油',59.99,1,'2'),(7,3,1,'江南菜籽油',59.99,1,'2'),(8,4,13,'鲤鱼',26.00,1,'2'),(9,5,1,'江南菜籽油',59.99,3,'2'),(11,15,15,'香蕉',8.90,3,'2');
