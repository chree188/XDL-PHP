...
insert  into `detail`(`id`,`orderid`,`goodsid`,`name`,`price`,`num`,`status`) values (2,1,10,'金龙鱼',59.90,1,'1'),(3,2,15,'香蕉',8.90,5,'2'),(4,2,16,'珍品海参',119.89,3,'2'),(5,2,14,'大草鱼',26.00,1,'2'),(6,2,1,'江南菜籽油',59.99,1,'2'),(7,3,1,'江南菜籽油',59.99,1,'2'),(8,4,13,'鲤鱼',26.00,1,'2'),(9,5,1,'江南菜籽油',59.99,3,'2');
...
insert  into `orders`(`id`,`odid`,`uid`,`linkman`,`address`,`code`,`phone`,`descr`,`evaluate`,`addtime`,`total`,`status`) values (1,'201607280915001122',1,'章佳鑫','召唤师峡谷','458712','13777399112','早点发货哦。。。。。。。。。。。。。',NULL,1469668523,237.90,'1'),(2,'201607280921407050',1,'轮回','召唤师峡谷2','458712','13777399387','早点发货，包装完好。。。',NULL,1469668941,490.16,'3'),(3,'201607280933233119',1,'老章','召唤师峡谷','458712','13777399112','快递',NULL,1469669617,59.99,'3'),(4,'201607281457583810',2,'剑圣','召唤师峡谷','145287','13777399388','5555','急急急',1469689085,26.00,'3'),(5,'201607281501015819',3,'莫甘娜','召唤师峡谷','124566','13777399001','兄弟连',NULL,1469689270,179.97,'2');
