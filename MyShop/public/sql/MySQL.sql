...
insert  into `detail`(`id`,`orderid`,`goodsid`,`name`,`price`,`num`) values (1,1,11,'临安山核桃',89.00,2),(2,1,10,'金龙鱼',59.90,1),(3,2,15,'香蕉',8.90,5),(4,2,16,'珍品海参',119.89,3),(5,2,14,'大草鱼',26.00,1),(6,2,1,'江南菜籽油',59.99,1),(7,3,1,'江南菜籽油',59.99,1),(8,4,13,'鲤鱼',26.00,1),(9,5,1,'江南菜籽油',59.99,3);
