...
//					输出到表格
					echo "<tr>";
						...
						echo "<td align=center>
							<a href='fileSystem.php?a=edit&filename={$ff}'>修改</a>
							<a href='fileSystem.php?a=del&filename={$ff}'>删除</a>
						</td>";
					echo "</tr>";
				}
			?>
		...
		<center>	
		<h4><a href="fileSystem.php?a=add" style="text-decoration: none;">新建文件</a></h4>
		<!--php处理部分-->
		<?php
			switch ($GETa) {
//				显示新建文件
				case 'add':
					echo "<form action='fileSystem.php?a=create' method='post'>";
