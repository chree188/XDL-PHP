...
<body leftmargin="8" topmargin="8" background='__IMG__/allbg.gif'>
    ...
    <div class="art_list_title">
    	<div class="sort_left">&nbsp;栏目详情管理--添加单页</div>
    </div>
    <div class="addsort_content">
    	<form action="__APP__/Single/singleadd" method="POST">
        	<table>
            	<tr>
                	<td>单页名称：</td>
                    <td><input type="text" class="input1 w300" name="title" /></td>
                </tr>
                <tr>
                	<td>单页状态：</td>
                    <td>
                ...
                <tr>
                	<td>内容编辑：</td>
                    <td><textarea name="content" class="w700 h300" id="contentid"></textarea></td>
                </tr>
                <tr>
