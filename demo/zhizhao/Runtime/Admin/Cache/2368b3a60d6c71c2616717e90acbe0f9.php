...
<body leftmargin="8" topmargin="8" background='__IMG__/allbg.gif'>
    ...
    <div class="art_list_title">
    	<div class="sort_left fl">&nbsp;友情链接列表管理</div>
        <div class="sort_right fr"><input type="button" value="添加友情链接" name="addSort" onclick="location.href='<?php echo U(APP_NAME .'/Link/addDetails');?>'" />&nbsp;&nbsp;</div>
        <div class="cb"></div>
    </div>
    <div class="art_list">
    	<form method="POST" action="<?php echo U(APP_NAME .'/Link/deletedetails/');?>" name="form">
        	<table class="tableList">
            	<thead>
                	<tr class="top_thead">
                    	<th width="60">&nbsp;选择</th>
                        <th width="40" align="center">ID</th>
                        <th align="left">友情链接名称</th>
                        <th align="left">友情链接地址</th>
                        <th align="left">友情链接备注</th>
                ...
                <tbody>
                	<?php if(is_array($list)): foreach($list as $key=>$data): ?><tr>
                            ...
                            <td align="left"><?php echo ($data["link_name"]); ?></td>
                            <td align="left"><?php echo ($data["link_url"]); ?></td>
                            <td align="left"><?php echo ($data["explain"]); ?></td>
                            <td align="left">&nbsp;<a href="<?php echo U(APP_NAME .'/Link/editDetails/',array('id'=>$data['id']));?>" title="编辑数据">编辑数据</a></td>
