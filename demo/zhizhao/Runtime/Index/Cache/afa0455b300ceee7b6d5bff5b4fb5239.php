        ...
        <div class="user_list">
			<div class="user_list_title">
            	<div class="user_list_titleL fl">
                	<a href="__APP__/User/index/uid/<?php echo ($_GET['uid']); ?>.html" class="article">TA的文章</a><a href="javascript:;" class="current comment" title="">TA的评论</a>
                </div>
                <div class="user_list_titleR fr pr z20">
                </div>
				<div class="cb"></div>
            </div>
            <!--列表--内容开始-->
            <div class="user_list_con">
            	<ul>
                	<?php if(is_array($commentList)): $i = 0; $__LIST__ = $commentList;if( count($__LIST__)==0 ) : echo "TA还没有评论" ;else: foreach($__LIST__ as $key=>$va): $mod = ($i % 2 );++$i;?><li>
                            <div class="articleTitle fl"><a href="<?php echo ($va["url"]); ?>" title="<?php echo (msubstr($va["comment"],0,20)); ?>"><?php echo (msubstr($va["comment"],0,50)); ?></a></div>
                            <div class="articleTime fr"><?php echo (date("Y-m-d H:i:s",$va["time"])); ?></div>
                            <div class="cb"></div>
                        </li><?php endforeach; endif; else: echo "TA还没有评论" ;endif; ?>    
                </ul>
            </div>
        </div>
        <div class="fpage">
