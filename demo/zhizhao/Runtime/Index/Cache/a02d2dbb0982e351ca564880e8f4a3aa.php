        ...
        <div class="leftBox fl">
            ...
            <div class="addBoxWrap">
                <div class="addBox">
                    ...
                    <div class="addBoxCon">
                        <form action="<?php echo U(APP_NAME .'/List/handleEditAsk');?>" method="POST" name="addArticle">
                            <input type="hidden" name="uid" value="<?php echo session('uid');?>">
                            <input type="hidden" name="aid" value="<?php echo ($article["id"]); ?>">
                            <ul>
                                <li>
                                    <span class="item3 fl"><b>*</b>标题</span>
                                    <input type="text" name="title" class="text1 fl" value="<?php echo ($article["ask_name"]); ?>" />
                                ...
                                <li>
                                    ...
                                    <select name="sort_id" class="select">
                                        <option value="0" <?php if(in_array(($article["sort_id"]), explode(',',"0"))): ?>selected="selected"<?php endif; ?>>请选择分类</option>
                                        <?php if(is_array($sortList)): $i = 0; $__LIST__ = $sortList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$va): $mod = ($i % 2 );++$i;?><option value="<?php echo ($va["id"]); ?>" <?php if(in_array(($article["sort_id"]), is_array($va["id"])?$va["id"]:explode(',',$va["id"]))): ?>selected="selected"<?php endif; ?>><?php echo ($va["sort_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                    <div class="msgContent fl none"></div>
                                    <div class="cb"></div>
                                </li>
                                <li>
                                    ...
                                    <select name="reward" class="select2">
                                        <option value="-1" <?php if(in_array(($article["reward"]), explode(',',"-1"))): ?>selected="selected"<?php endif; ?>>请选择悬赏金币( 当前金币 <?php echo ($userInfo["point"]); ?> )</option>
                                        <option value="0" <?php if(($userInfo['point']) <= "0"): ?>disabled="disabled"<?php endif; ?>  <?php if(in_array(($article["reward"]), explode(',',"0"))): ?>selected="selected"<?php endif; ?>>0</option>
                                        <option value="5" <?php if(($userInfo['point']) <= "5"): ?>disabled="disabled"<?php endif; ?>  <?php if(in_array(($article["reward"]), explode(',',"5"))): ?>selected="selected"<?php endif; ?>>5</option>
                                        <option value="10" <?php if(($userInfo['point']) <= "10"): ?>disabled="disabled"<?php endif; ?> <?php if(in_array(($article["reward"]), explode(',',"10"))): ?>selected="selected"<?php endif; ?>>10</option>
                                        <option value="15" <?php if(($userInfo['point']) <= "15"): ?>disabled="disabled"<?php endif; ?> <?php if(in_array(($article["reward"]), explode(',',"15"))): ?>selected="selected"<?php endif; ?>>15</option>
                                        <option value="20" <?php if(($userInfo['point']) <= "20"): ?>disabled="disabled"<?php endif; ?> <?php if(in_array(($article["reward"]), explode(',',"20"))): ?>selected="selected"<?php endif; ?>>20</option>
                                        <option value="30" <?php if(($userInfo['point']) <= "30"): ?>disabled="disabled"<?php endif; ?> <?php if(in_array(($article["reward"]), explode(',',"30"))): ?>selected="selected"<?php endif; ?>>30</option>
                                        <option value="50" <?php if(($userInfo['point']) <= "50"): ?>disabled="disabled"<?php endif; ?> <?php if(in_array(($article["reward"]), explode(',',"50"))): ?>selected="selected"<?php endif; ?>>50</option>
                                        <option value="100" <?php if(($userInfo['point']) <= "100"): ?>disabled="disabled"<?php endif; ?> <?php if(in_array(($article["reward"]), explode(',',"100"))): ?>selected="selected"<?php endif; ?>>100</option>
                                    </select>
                                    <div class="msgContent fl none"></div>
                                    <div class="cb"></div>
                                </li>
                                <li>
                                    ...
                                    <textarea name="content" class="textarea2 fl" id="content"><?php echo ($article["content"]); ?></textarea>
