...
<li class='mycollect <?php if(ACTION_NAME == 'collect'): ?>cur<?php endif; ?>'> <a href="<?php echo U(APP_NAME .'/Member/collect');?>">我的金币</a> </li>
    ...
    <div id="right">
    	<div class="artcileBox">
        	<div class="artcileTitle"><h4>我的私信</h4></div>
            <div class="article_tab">
            	<div class="article_tab_title">
                	<ul>
                    	<li class="current"><a href="javascript:;">未读</a></li>
                        <li><a href="<?php echo U(APP_NAME.'/Member/readedLetter');?>">已读</a></li>
                    </ul>
                </div>
                <div class="letter_tab_con">
                	<!--调十二条-->
                	<ul>
                    	<?php if(is_array($letterList)): $i = 0; $__LIST__ = $letterList;if( count($__LIST__)==0 ) : echo "暂无私信" ;else: foreach($__LIST__ as $key=>$va): $mod = ($i % 2 );++$i;?><li>
                                <div class="imgBox fl"><a href=""><img src="<?php echo ($va["face"]); ?>" alt="<?php echo ($va["send_user"]); ?>" /></a></div>
                                <div class="textBox fr">
                                    <p><?php echo ($va["send_user"]); ?>&nbsp;&nbsp;在&nbsp;<?php echo (time_format($va["time"])); ?>&nbsp;私信了你</p>
                                    <p>主题：<a href="<?php echo U(APP_NAME.'/Member/mlStatus',array('id'=>$va["id"]));?>" title="<?php echo ($va["title"]); ?>"><?php echo ($va["title"]); ?></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo U(APP_NAME.'/Member/mlStatus',array('id'=>$va["id"]));?>" title="去查看" style="color:#09F;">去查看</a></p>
                                </div>
                                <div class="cb"></div>
                            </li><?php endforeach; endif; else: echo "暂无私信" ;endif; ?>
                    </ul>
                </div>
                <div class="fpage">
                	<?php echo ($page); ?>
