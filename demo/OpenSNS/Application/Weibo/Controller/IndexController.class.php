...
class IndexController extends BaseController
{
    ...
    {
        $uid = is_login();
        $check = D('member')->where(array('uid' => $uid))->field('con_check, total_check')->select();
    ...
    public function doSendRepost()
    {
        ...
        send_message($toUid, L('_PROMPT_TRANSMIT_'), $message_content, 'Weibo/Index/weiboDetail', array('id' => $new_id), is_login(), 'Weibo','Weibo_comment');
