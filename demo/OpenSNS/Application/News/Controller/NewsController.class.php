    ...
    public function add($id = 0, $pid = 0)
    {
        ...
        if (IS_POST) {
            ...
            $builder->title($title.L('_CATEGORY_'))
                ...
                ->keyRadio('can_post',L('_PLAY_YN_'),'',array(0=>L(''),1=>L('_YES_')))->keyDefault('can_post',1)
                ->keyRadio('need_audit',L('_PLAY_YN_AUDIT_'),'',array(0=>L(''),1=>L('_YES_')))->keyDefault('need_audit',1)
