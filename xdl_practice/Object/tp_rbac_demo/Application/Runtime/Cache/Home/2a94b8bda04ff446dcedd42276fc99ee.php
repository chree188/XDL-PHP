...
<html>
<head>
<title>EleganceMedia a Entertainment Category Flat Bootstarp Responsive Website Template | Home :: w3layouts</title>
<link href="/s51/object02/tp_rbac_demo/Public/Home/css/bootstrap.css" rel="stylesheet" type="text/css" media="all">
<link href="/s51/object02/tp_rbac_demo/Public/Home/css/style.css" rel="stylesheet" type="text/css" media="all" />
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="EleganceMedia Responsive web template, Bootstrap Web Templates, Flat Web Templates, Andriod Compatible web template, 
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design" />
<script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false); function hideURLbar(){ window.scrollTo(0,1); } </script>
<!-- <link href='http://fonts.googleapis.com/css?family=Open+Sans:700,300,600,800,400' rel='stylesheet' type='text/css'> -->
<script src="/s51/object02/tp_rbac_demo/Public/Home/js/jquery.min.js"></script>
...
<!-- header -->
	<div class="header">
		<div class="container">
			<div class="logo">
				<a href="index.html"><img src="/s51/object02/tp_rbac_demo/Public/Home/images/logo.png" class="img-responsive" alt=""></a>
			</div>
			<?php echo W('Nav/menu');?>
		...
		<div class="container">
			<ul id="flexiselDemo3">
								<li><a href="single.html">
									<div class="banner-1">
										<img src="/s51/object02/tp_rbac_demo/Public/Home/images/1.jpg" class="img-responsive" alt="">
								...
								<a href="single.html">
									<div class="banner-1">
										<img src="/s51/object02/tp_rbac_demo/Public/Home/images/2.jpg" class="img-responsive" alt="">
										<div class="banner-bottom">
											<h4>Digital Art</h4>
								...
								<a href="single.html">
									<div class="banner-1">
										<img src="/s51/object02/tp_rbac_demo/Public/Home/images/3.jpg" class="img-responsive" alt="">
										<div class="banner-bottom">
											<h4>Thismanslife: New </h4>
											<p>from Creattica by this life</p>
										</div>
									</div></a>
								</li>
								<li>
								<a href="single.html">
									<div class="banner-1">
										<img src="/s51/object02/tp_rbac_demo/Public/Home/images/4.jpg" class="img-responsive" alt="">
										<div class="banner-bottom">
											<h4>Business Graph</h4>
											<p>by GraphicsFuel for impl</p>
										</div>
									</div></a>
								</li>
							 </ul>
						 ...
						 <script type="text/javascript">
							...
							<script type="text/javascript" src="/s51/object02/tp_rbac_demo/Public/Home/js/jquery.flexisel.js"></script>
				<div class="clearfix"> </div>
		</div>
	</div>
<!-- banner -->
	...
	<div class="later">
		<div class="container">
			<div class="col-md-6 later-left">
				<li><h5>Newsletter sign up</h5></li>
				<li>
					<div class="stay">
						<div class="stay-left">
							<form>
