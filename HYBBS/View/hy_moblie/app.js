...
function open_lt(username,uid,avatar){
	...
	if(_this.length == 0){
		...
		//eval('window.is_'+uid+' = null');
			...
			document.getElementById('is-obj-'+uid).iscroll = new IScroll('.is-'+uid, {
					    mouseWheel: true,
					    scrollbars: true,
					  	fadeScrollbars:true,
	...
	document.getElementById('is-obj-'+uid).iscroll.refresh();
...
function tog_friend_box(){
	...
	if(friend_obj == null){
		...
		window.myScrol1 = null;
		
		window.myScrol3 = null;
		window.myScrol0 = null;
		setTimeout(function(){
			$("#friend-tab a").click(function(){
				...
				window.myScrol1.refresh();
				window.myScrol3.refresh();
				window.myScrol0.refresh();
		...
		$.ajax({
	        ...
	        success:function(e){
	            ...
	            setTimeout(function(){
	            	window.myScrol1 = new IScroll('#friend-1', {
					    disableMouse: true,
					    disablePointer: true,
					    mouseWheel: true,
					    scrollbars: true,
					...
					window.myScrol3 = new IScroll('#friend-3', {
					    disableMouse: true,
					    disablePointer: true,
					    mouseWheel: true,
					    scrollbars: true,
					...
					window.myScrol0 = new IScroll('#friend-0', {
					    disableMouse: true,
					    disablePointer: true,
					    mouseWheel: true,
					    scrollbars: true,
...
function add_lt(id,pos,user,content,time,avatar){
    ...
    document.getElementById('is-obj-'+id).iscroll.refresh();
...
function url_back(test){
	...
	console.log(document.referrer.search(www+"t"));
	if(document.referrer == '' || document.referrer.search("/post") != -1 || document.referrer.search("/user") != -1)
