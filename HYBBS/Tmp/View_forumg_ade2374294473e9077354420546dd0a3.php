				...
				<tbody>
                    ...
                    <tr >
                        ...
                        <td>
                            ...
                            <?php endforeach ?>
                            <button onclick="$('#gn').val('forumg');$('.modal-body').load(window.location.pathname+'?id=<?php echo $v['id'];?>&gn=forumg')" type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#normalModal">编辑</button>
                        </td>
                    </tr>
                    <?php endforeach ?>
