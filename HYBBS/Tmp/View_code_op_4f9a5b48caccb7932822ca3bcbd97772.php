        ...
        <div class="padding-md">
            ...
            <div class="gallery-filter m-top-md" style="margin:10px 0">
                <ul class="clearfix">
                    ...
                    <li class="active"><a href="<?php echo WWW;?>admin<?php echo EXP;?>code_op">插件优先级</a></li>
            ...
            <div class="col-sm-12">
                <div class="smart-widget">
                    <div class="smart-widget-header">
                        <i class="fa fa-<?php echo $v['conf']['icon'];?> fa-2x"></i> <?php echo $v['conf']['name'];?> <span class="badge badge-info"><?php echo $v['name'];?></span>
                    ...
                    <div class="smart-widget-inner" style="display: block;">
                        ...
                        <div class="smart-widget-body">
                            <small style="color: purple" class="text-muted">作者: <?php echo $v['conf']['user'];?> <strong style="color: darkcyan;"> &nbsp;版本:<?php echo $v['conf']['version'];?></strong></small>
                            <div class="seperator"></div>
                            <p class="m-bottom-none">
                                <?php echo $v['conf']['mess'];?>
                            </p>
                            <div class="list-group">
                                <?php foreach ($v['hook'] as $vv): ?>
                                <a href="javascript:void(0)" class="list-group-item "><?php echo str_replace('.hook','',$vv); ?> <input class="input-hook pull-right" type="text" style="width:50px" code="<?php echo $v['name'];?>" hook="<?php echo $vv;?>"> <span class="label label-success pull-right" style="margin-right:10px"><?php if (isset($v['p'][$vv])): ?><?php echo $v['p'][$vv];?><?php endif ?></span></a>
                                <?php endforeach ?>
                             <?php if (isset($v['p'][$vv])): ?><?php endif ?>
                            </div>
                        </div>
...
<script type="text/javascript">
    window.onload = function(){
        $(".input-hook").blur(function(){
            ...
            $.post('<?php echo WWW;?>admin<?php echo EXP;?>code_op',{hook:hook,code:code,value:v},function(e){
