  ...
  <div id="page" class="mc cls"> 
    ...
    <div class="loginWrap">
      <div class="loginTitle">
        <h3>用户登录<span>还没有账号？点此 <a href="<?php echo U(APP_NAME.'/Login/register');?>">注册</a></span></h3>
      </div>
      <div class="loginContent">
        <form action="<?php echo U(APP_NAME.'/Login/handleLogin');?>" method="POST" name="login">
          <table>
            ...
            <tr><td class="w80 tc item1"></td><td><input type="checkbox" name="auto" checked="checked" class="checkbox1" />下一次自动登录</td></tr>
            <tr><td class="w80 tc item1"></td><td><input type="submit" value="登录" class="sub1" /></td></tr>
          </table>
        </form>
      </div>
    </div>
